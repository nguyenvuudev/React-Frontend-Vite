...
const Home = () => {
    ...
    return (
        <div className="homepage-container" style={{ maxWidth: '100vw', margin: '0 auto' }}>
            <Row gutter={[20, 20]}>
                    ...
                    >
                        ...
                        >
                            <div>
                                ...
                                <span className="customize-rate-navber-homepage"></span>
                            </div>
                            <div>
                                <Rate value={4} disabled style={{ color: '#ffce3d', fontSize: 15 }} />
                                <span className="customize-rate-navber-homepage">trở lên</span>
                            </div>
                            <div>
                ...
                <Col md={20} xs={24} style={{ border: "1px solid red" }}>
                    ...
                    <Row className='wrapper-all-data'>
                        <div className="customize-mock-data">
                            <div className='wrap-mock-data'>
                                ...
                                <div className='rating'>
                                    ...
                                    <span style={{marginLeft:"10px"}}>Đã bán 1k</span>
                                </div>
                            </div>
                        </div>  
                        <div className="customize-mock-data">
